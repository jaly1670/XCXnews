  ...
  <div class="tab_box"> 
    ...
    <div>
      ...
      <form id="formstu" method="post" class="stu_login_error">
        ...
        <div id="password">
          <label>手&nbsp;&nbsp;&nbsp;机：</label>
          <input type="text" id="custPhone" name="custPhone" placeholder="输入手机号" />
        </div>
        <div id="password">
          <label>微&nbsp;&nbsp;&nbsp;信：</label>
          <input type="text" id="custWeixin" name="custWeixin" placeholder="输入微信" />
        </div>
        <div id="login">
          <button type="submit" id="studl">注册</button>
        </div>
      </form>
    </div>
   <!-- 学生登录结束-->
